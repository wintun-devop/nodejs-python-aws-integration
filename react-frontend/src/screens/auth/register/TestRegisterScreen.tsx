...
import { FormInputTextField } from '../../../components/custom-hook-form-components/FormInputTextField';
...
const TestRegisterScreen = () =>{
    ...
    > 
    <Paper elevation={10} 
    style={{padding:20,height:'70vh',width:280,margin:"20px auto",alignItems: 'center' }}
    >
        {/* Avatar icon */}
